...
public class PersonalActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        initializeWidgets();
        initializeListeners();
        taskArrayAdapter = new ArrayAdapter<>(PersonalActivity.this, android.R.layout.simple_list_item_1, tasks);
    ...
    private void initializeListeners() {
        dateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(PersonalActivity.this,
        ...
        timeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(PersonalActivity.this,
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (dueDateTime != null && !taskName.isEmpty()) { // Check if dueDateTime is not null
                    ...
                    Toast.makeText(PersonalActivity.this, "Please select a date and time", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        taskList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                Toast.makeText(PersonalActivity.this, remainingTime, Toast.LENGTH_LONG).show();
            }
        });
                ...
                new AlertDialog.Builder(PersonalActivity.this)
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                taskArrayAdapter.notifyDataSetChanged(); // Notify adapter of data change
                                Toast.makeText(PersonalActivity.this, "Task deleted", Toast.LENGTH_SHORT).show();
                            }
                        })
